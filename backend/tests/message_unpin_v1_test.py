...
'''
import pytest
from src.message import message_unpin_v1, message_pin_v1, message_send_v1, message_send_dm_v1
...
def test_message_unpin_v1_message_id_invalid():
    ...
    message = 'Sent from test_message_unpin_v1_message_id_invalid'
    ...
    with pytest.raises(InputError):
        message_unpin_v1(owner_details['token'], sent_message_details['message_id'] + 1)
    # try to pin non exiting message in dm of id 1
    with pytest.raises(InputError):
        message_unpin_v1(owner_details['token'], sent_message_dm_details['message_id'] - 1)

    # try to pin invalid message_id in channel of id 1
    with pytest.raises(InputError):
        message_unpin_v1(owner_details['token'], 34)
    # try to pin invalid message_id in dm of id 1
    with pytest.raises(InputError):
        message_unpin_v1(owner_details['token'], -12)
...
def test_message_unpin_v1_message_already_unpinned():
    ...
    # send a message in said channel
    message = 'Sent from test_message_unpin_v1_message_already_unpinned'
    sent_message_details = message_send_v1(owner_details['token'], channel_details['channel_id'], message)

    # second pin
    with pytest.raises(InputError):
        message_unpin_v1(owner_details['token'], sent_message_details['message_id'])
...
def test_message_unpin_v1_message_auth_not_owner():
    ...
    message = 'Sent from test_message_unpin_v1_message_auth_not_owner'
    ...
    # non owner tries to unpin the message
    with pytest.raises(AccessError):
        message_unpin_v1(user_details['token'], sent_message_details['message_id'])
...
def test_message_unpin_v1_message_unpinned_successfully():
    ...
    # send a message in said channel
    message = 'Sent from test_message_unpin_v1_message_unpinned_successfully'
    sent_message_details = message_send_v1(owner_details['token'], channel_details['channel_id'], message)
