...
Contains tests for channel remove owner v1.
...
def test_channel_removeowner_basic():
    '''
    Basic test to check channel/removeowner/v1 returns correct output in basic success 
    case.
    '''    
...
def test_removeowner_input_error_invalid_channel():
    '''
...
def test_removeowner_input_error_invalid_uid():
    '''
...
def test_removeowner_input_error_non_owner():
    '''
    tests for status code 400 (input error) - non owner.
    '''
    requests.delete(f"{BASE_URL}/clear/v1")
    # dummy user
    response = requests.post(f"{BASE_URL}/auth/register/v2", json = {
...
def test_removeowner_input_error_only_owner():
    '''
    tests for status code 400 (input error) - only remaining owner.
    '''
    requests.delete(f"{BASE_URL}/clear/v1")
    # dummy user
    response = requests.post(f"{BASE_URL}/auth/register/v2", json = {
...
def test_removeowner_AccessError():
    '''
...
def test_globalowner_nonmember_cannot_remove_channelowner():
    requests.delete(f"{BASE_URL}/clear/v1")
    # dummy user
    response = requests.post(f"{BASE_URL}/auth/register/v2", json = {
        'email': 'dummy@hotmail.com',
